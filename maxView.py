...
def poc(url):
    ...
    try:
        ...
        if r.status_code == 200 and 'xhs' in r.text:
            print('\033[1;31m' + '[+] Success ' + vulnurl + '\033[0m')
...
def help():
    helpinfo = """                             _                 __    ___   __ 
 _ __ ___   __ ___  __/\   /(_) _____      __ /__\  / __\ /__\/
| '_ ` _ \ / _` \ \/ /\ \ / / |/ _ \ \ /\ / // \// / /   /_\  
| | | | | | (_| |>  <  \ V /| |  __/\ V  V // _  \/ /___//__  
|_| |_| |_|\__,_/_/\_\  \_/ |_|\___| \_/\_(_)/ \_/\____/\__/  
"""
    print(helpinfo)
    print("maxView.RCE".center(100, '*'))
...
def main():
    parser = argparse.ArgumentParser(description='maxView.RCE漏洞单批检测脚本@ztomato')
